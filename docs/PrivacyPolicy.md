...
If this policy changes, the "Last updated" date above will be revised. Since the app collects
no data, changes are expected to be rare and minor (e.g., clarifying language).
...
*(Replace the email above with the address you want to use as your public support contact
